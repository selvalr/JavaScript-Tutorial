...
alert(person1.firstName + " " + person1.lastName); //steve Jobs

var person2 = new Person();
person2.firstName = "Bill";
person2.lastName = "Gates";

alert(person2.firstName + " " + person2.lastName);//Bill Gates
*/
...
alert(person1.getFullName()); //steve Jobs

var person2 = new Person();
person2.firstName = "Bill";
person2.lastName = "Gates";

alert(person2.getFullName());//Bill Gates
*/
...
alert(person1.getFullName()); //James Bond

var person2 = new Person("Tom", "Paul");
alert(person2.getFullName()); //Tom Paul
*/
...
var person1 = new Person();
person1.FirstName = "Steve";
alert(person1.FirstName); //steve

var person2 = new Person();
person2.FirstName = "Bill";
alert(person2.FirstName); //Bill
*/
