...
// try {
//   alert("Start of try runs"); // (1) <--// ...no errors here
...
//   alert("End of try (never reached)"); // (3)-->not executed
// } catch (err) {
//   alert(`Error has occurred!`); // (2) <--
// }
...
// try {
//   setTimeout(function () {
//     let noSuchVariable = 0; // script will die here
...
// } catch (err) {
//   console.log(err.name + "<br>" + err.message); //ReferenceError<br>adddlert is not defined
// }
